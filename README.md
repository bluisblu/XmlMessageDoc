...
| Actionscript Name           | XML Tag                       | Description                                                                                                                                                               | Example |
| --------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| sendAddBuddy                | [u_abd](User-Plugin.md#u_abd) | `b` - buddy id `if arg typeof number`<br>`n` - the value `else if arg typeof not string`                                                                                  |         |
| sendAddBuddyResponse        | [u_abr](User-Plugin.md#u_abr) | `b` - buddy id `if arg typeof number`<br>`n` - the value `else if arg typeof not string`<br>`r` - answer<br>`a` - reason, if any                                          |         |
